...
namespace Crypto_Api.Domain.Common
{
    public class Result : IResult
    {
        ...
        {
            return new Result
                { ResultStatus = ResultStatus.Error, Succeeded = false, Messages = new List<string>() { message } };
        }
        ...
        {
            return new Result
                { ResultStatus = ResultStatus.Success, Succeeded = true, Messages = new List<string> { message } };
        }
